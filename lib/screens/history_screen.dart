...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Future<void> _deleteHistoryItem(String docId, String imageUrl) async {
    try {
      ...
      _showSnackBar('History item deleted successfully!');
    } catch (e) {
      print('Error deleting image from storage: $e');
      _showSnackBar('Error deleting history item.');
    }
  }
    ...
    if (shouldDeleteAll == true) {
      ...
      try {
        ...
        for (var doc in snapshot.docs) {
          ...
          await _deleteHistoryItem(doc.id, imageUrl);
        }
        ...
        _showSnackBar('Error deleting all history items.');
        setState(() {
          _isLoading = false;
        });
      }
